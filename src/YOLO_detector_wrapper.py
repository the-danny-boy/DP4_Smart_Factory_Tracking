...
from ScaledYOLOv4.utils.general import (check_img_size, non_max_suppression, scale_coords)
from ScaledYOLOv4.utils.datasets import letterbox
...
def detect_wrapper(frame, model=None, debug=False):
            ...
            if d is not None:
                for b in d:
                    ...
                    if debug:
                        ...
                        cv2.drawMarker(debug_frame, centroid, color=(0,0,255), markerType=cv2.MARKER_CROSS, markerSize=20, thickness=4)
